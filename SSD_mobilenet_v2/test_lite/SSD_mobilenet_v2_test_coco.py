...
class SSD():
    ...
    def test(self):
        ...
        with tf.Session(config=config) as sess:
            ...
            for name in names[:m]:
                ...
                # img=tf.gfile.GFile(im_file,'rb').read()
            ...
            joblib.dump(Res, 'SSD300_lite.pkl')
    ...
    def save_pb(self):
        ...
        file = '/home/yuqing/PycharmProjects/Demo35/SSD_mobilenet_v2/train/models/SSD300_1.ckpt-15000'
...
if __name__ == "__main__":
    ...
    pre_model = '/home/yuqing/PycharmProjects/Demo35/SSD_mobilenet_v2/train_lite/models/SSD300_2.ckpt-60000'
