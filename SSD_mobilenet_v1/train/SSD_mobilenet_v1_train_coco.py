...
class SSD():
    ...
    def build_net(self, Iter):
        ...
        with tf.variable_scope('FeatureExtractor'):
            with slim.arg_scope(
                    mobilenet_v1.mobilenet_v1_arg_scope(is_training=self.config.is_train, batch_norm_decay=0.9997,
                                                        stddev=0.03)):
...
if __name__ == "__main__":
    ...
    pre_model = r'/home/yuqing/PycharmProjects/Demo35/tensorflow_zoo/ssd_mobilenet_v1_coco_2018_01_28/ssd_mobilenet_v1_coco_2018_01_28/model.ckpt'
